...
DISCOURSE_SERVE_STATIC_ASSETS="${DISCOURSE_SERVE_STATIC_ASSETS:-false}"
export DISCOURSE_SERVE_STATIC_ASSETS="${DISCOURSE_SERVE_STATIC_ASSETS:-false}"
DISCOURSE_ENABLE_LONG_POLLING="${DISCOURSE_ENABLE_LONG_POLLING:-false}"
